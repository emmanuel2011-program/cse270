...
class TestSmoketest():
  ...
  def test_adminpage(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/join-step2.html?fname=Emmanuel&lname=Okoye&bizname=mandb+annnnn&biztitle=direcorate&submit=Next+Step")
    self.driver.set_window_size(1295, 687)
    self.driver.find_element(By.LINK_TEXT, "Admin").click()
    elements = self.driver.find_elements(By.ID, "username")
    assert len(elements) > 0
    self.driver.find_element(By.ID, "username").send_keys("ty")
    self.driver.find_element(By.ID, "password").click()
    self.driver.find_element(By.ID, "password").send_keys("4")
  ...
  def test_joinpage(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("emmanuel")
    self.driver.find_element(By.NAME, "lname").click()
    self.driver.find_element(By.NAME, "lname").send_keys("okoye")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("mandb")
